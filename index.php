    ...
    <body class="">
        ...
        <section class="banner py-5 position-relative">
            <div class="shape-1 ms-lg-5 position-absolute top-50 start-0 translate-middle-y" data-aos="fade-right">
                <img src="images/svg/shape_1.png" alt="img" data-aos="zoom-in">
            </div>
            <div class="shape-2 me-lg-5 position-absolute top-50 end-0 translate-middle-y" data-aos="fade-left">
                <img src="images/svg/shape_5.png" alt="img" data-aos="zoom-in">
            </div>
            <div class="container position-absolute top-50 start-50 translate-middle">
                <div class="d-flex justify-content-center align-items-center gap-2">
                    <img src="images/svg/shape_1.png" class="d-md-none" alt="img" data-aos="zoom-in" style="height: 70px; width: auto;">
                    <img src="images/svg/shape_5.png" class="d-md-none" alt="img" data-aos="zoom-in" style="height: 70px; width: auto;">
                </div>
